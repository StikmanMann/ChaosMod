...
export class Ollama {
  ...
  protected async processStreamableRequest<T extends object>(
  ...
  ): Promise<T | utils.AbortableAsyncIterator<T>> {
    ...
    if (request.stream) {
      ...
      const abortableAsyncIterator = new utils.AbortableAsyncIterator(
        abortController,
        itr,
        () => {
  ...
  ): Promise<utils.AbortableAsyncIterator<GenerateResponse>>;
  generate(
  ...
  async generate(
    ...
    GenerateResponse | utils.AbortableAsyncIterator<GenerateResponse>
  > {
    // if (request.images) {
  ...
  ): Promise<utils.AbortableAsyncIterator<ChatResponse>>;
  ...
  async chat(
    request: ChatRequest
  ): Promise<ChatResponse | utils.AbortableAsyncIterator<ChatResponse>> {
    if (request.messages) {
  ...
  ): Promise<utils.AbortableAsyncIterator<ProgressResponse>>;
  create(
  ...
  async create(
    ...
    ProgressResponse | utils.AbortableAsyncIterator<ProgressResponse>
  > {
